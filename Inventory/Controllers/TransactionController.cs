...
public class TransactionController : ControllerBase
{
    ...
    public struct TransactionCreate
    {
        ...
        [HttpPost("CreateTransaction/Buy" , Name = "CreateTransaction")]

        public ActionResult CreateTransaction([FromBody] TransactionCreate transactionCreate)
        {
        ...
        [HttpPost("CreateTransaction/Fill" , Name = "FillProduct")]
        ...
        [HttpPost("CreateTransaction/OutofDate" , Name = "OutofDate")]
        ...
        [HttpGet( "ViewTransection" , Name = "ViewTransection")]
