...
public class CatigoriesController : ControllerBase
{
    ...
    private readonly ILogger<CatigoriesController> _logger;

    public CatigoriesController(ILogger<CatigoriesController> logger)
    {
        _logger = logger;
    }
    ...
    public struct CategoryCreate
    {
        ...
        public ActionResult CreateCategory([FromBody] CategoryCreate categoryCreate)
        {
            ...
            catigory = Catigory.Create( _db, catigory);
            return Ok(catigory);
        }
        ...
        public ActionResult ViewCatigories()
            {
                ...
                List<Catigory> catigories = Catigory.GetAll(_db).OrderBy(q => q.Id).ToList();
